package com.rocketbunny.swiftmapper.utils.validation;

import com.rocketbunny.swiftmapper.annotations.entity.Column;
import com.rocketbunny.swiftmapper.annotations.validation.*;
...
public class Validator {
    ...
    private static void validatePattern(Field field, Object value) {
        com.rocketbunny.swiftmapper.annotations.validation.Pattern annotation =
                field.getAnnotation(com.rocketbunny.swiftmapper.annotations.validation.Pattern.class);
        if (annotation == null || value == null) return;
